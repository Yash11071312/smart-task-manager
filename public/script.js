...
document.addEventListener("DOMContentLoaded", () => {
    ...
    status.classList.remove('loading-spinner'); // Remove spinner
    }
    ...
    try {
        ...
        typeText(content, planHtml); // Use typing animation
    ...
    if (res.ok) {
        ...
        // Correct transition: hide the wrapper, not just the card
        document.getElementById("authWrapper").style.display = "none";
        document.getElementById("appSection").classList.add('page');
        document.getElementById("appSection").style.display = "block"; // Show App wrapper
        initCharts();
